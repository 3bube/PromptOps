      ...
      <div className="relative z-10 w-full max-w-100">
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
          <div className="space-y-3.5">
            <button
              type="button"
              className="group flex w-full items-center justify-center gap-3 rounded-xl border border-zinc-200 bg-white px-4 py-3.5 text-sm font-medium text-zinc-700 shadow-sm transition-all hover:bg-zinc-50 hover:text-zinc-900 focus:outline-none focus:ring-2 focus:ring-zinc-200 focus:ring-offset-1"
            >
            ...
            <button
              type="button"
              className="group flex w-full items-center justify-center gap-3 rounded-xl border border-transparent bg-[#24292F] px-4 py-3.5 text-sm font-medium text-white shadow-sm transition-all hover:bg-[#24292F]/90 focus:outline-none focus:ring-2 focus:ring-[#24292F] focus:ring-offset-1"
            >
