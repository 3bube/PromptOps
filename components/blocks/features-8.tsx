...
import { SectionHeading } from "@/components/v2/sections";
...
export function Features({
  ...
  useEffect(() => {
    if (!maskPathRef.current || !containerRef.current) return;
  ...
  return (
    <section id="features" className="bg-gray-50 py-16 md:py-32 " ref={containerRef}>
      <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
        ...
        <div className="relative">
          <div className="relative z-10 grid grid-cols-6 gap-3">
            <Card className="bg-white border-zinc-200 text-zinc-900 shadow-sm relative col-span-full flex overflow-hidden lg:col-span-2">
              <CardContent className="relative m-auto size-fit pt-6">
                  ...
                  >
                    <defs>
                      <mask id="circleMask">
                        <path
                          ref={maskPathRef}
                          d="M127,10 C220,10 250,30 250,52 C250,74 220,94 127,94 C34,94 4,74 4,52 C4,30 34,10 127,10"
                          fill="none"
                          stroke="white"
                          strokeWidth="40"
                          strokeLinecap="round"
                ...
                <p className="mt-2 text-center text-sm text-muted-foreground px-4 pb-4">
                  Define variables and watch them map seamlessly across your
                  context.
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white border-zinc-200 text-zinc-900 shadow-sm relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                ...
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Save effective goals or complex constraints to drop into
                    future prompts.
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="bg-white border-zinc-200 text-zinc-900 shadow-sm relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Deploy and test prompts rapidly with minimal latency.
                  </p>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-white border-zinc-200 text-zinc-900 shadow-sm relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Keep your prompts cost-effective with real-time estimation
                ...
                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6">
                  <div className="absolute left-3 top-2 flex gap-1">
                    <span className="block size-2 rounded-full border  dark:bg-white/10"></span>
                    <span className="block size-2 rounded-full border  dark:bg-white/10"></span>
                    <span className="block size-2 rounded-full border  dark:bg-white/10"></span>
                  </div>
                  <svg
              ...
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Export cleanly to JSON or SDK snippets that drop
                ...
                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                  <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-white">
                        TypeScript
                      </span>
                      <div className="ring-white size-7 ring-4 bg-zinc-50 flex items-center justify-center rounded-full border">
                        <Code2 className="size-3.5 text-zinc-600" />
                      </div>
                    </div>
                    <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                      <div className="ring-white size-8 ring-4 bg-zinc-50 flex items-center justify-center rounded-full border">
